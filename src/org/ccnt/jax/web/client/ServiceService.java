 ...
 * 
 */
@WebServiceClient(name = "ServiceService", targetNamespace = "http://serviceMapper.ouc.com/", wsdlLocation = "http://localhost:8080/WebServiceDemo/Service/testfindUser?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICESERVICE_QNAME = new QName("http://serviceMapper.ouc.com/", "ServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebServiceDemo/Service/testfindUser?wsdl");
    ...
    public org.ccnt.jax.web.client.Service getServicePort() {
        return super.getPort(new QName("http://serviceMapper.ouc.com/", "ServicePort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public org.ccnt.jax.web.client.Service getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serviceMapper.ouc.com/", "ServicePort"), Service.class, features);
    }
