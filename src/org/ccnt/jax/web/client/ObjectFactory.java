 ...
 * generated in the org.ccnt.jax.web.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _TestService_QNAME = new QName("http://service.ouc.com/", "testService");
    private final static QName _TestServiceResponse_QNAME = new QName("http://service.ouc.com/", "testServiceResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.ccnt.jax.web.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ouc.com/", name = "testService")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ouc.com/", name = "testServiceResponse")
